...
RSpec.describe Post, type: :model do
  ...
  context 'Testing recent_comments method' do
    ...
    before(:all) do
      Comment.new(text: 'Lorem Ipsum 1', author: user, post:).save
      Comment.new(text: 'Lorem Ipsum 2', author: user, post:).save
      Comment.new(text: 'Lorem Ipsum 3', author: user, post:).save
      Comment.new(text: 'Lorem Ipsum 4', author: user, post:).save
      Comment.new(text: 'Lorem Ipsum 5', author: user, post:).save
      Comment.new(text: 'Lorem Ipsum 6', author: user, post:).save
    end
